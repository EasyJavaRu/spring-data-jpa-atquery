...
public class DalIT {
    ...
    public void testGreeter() {
        passportRepository.findByOwner("Testoff")
                .forEach(System.out::println);

        passportRepository.ownerStartsWith("Te")
                .forEach(System.out::println);

        passportRepository.findByOwner("Testoff").forEach( p -> personRepository.personWithPasportSeries(p)
                .forEach(System.out::println));
    }
}
